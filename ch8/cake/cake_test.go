...
import (
	...
	"github.com/klbrg/gopl2/ch8/cake"
)

// TestMain parses the test flags before any test runs. testing.Verbose reads
// -test.v, so it must not be called during package initialization; doing so
// panics with "testing: Verbose called before Parse".
